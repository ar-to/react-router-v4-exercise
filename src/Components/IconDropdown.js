...
export default class IconMenuExampleControlled extends Component {
  ...
  render() {
    return (
      <div>
        <IconMenu
          iconButtonElement={<IconButton><PortraitIcon className='md-48'/></IconButton>}
        ...
        <IconMenu
          iconButtonElement={<IconButton><i className="material-icons md-48">face</i></IconButton>}
